...
#import "HaishijuHywpjgDetailViewController.h"
#import "HaishijuServerHelper.h"

@interface HaishijuHywpjgDetailViewController ()

@end

@implementation HaishijuHywpjgDetailViewController
...
-(void)loadInfoBySendRequest:(NSString*)chuanID
{
    ...
    //修改url中的type的参数
    NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataDetail.asp?type=hywpjg&ID=%@",chuanID];
