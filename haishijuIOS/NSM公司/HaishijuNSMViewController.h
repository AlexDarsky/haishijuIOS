...
@interface HaishijuNSMViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (strong,nonatomic) HaishijuNSMDetailViewController *gzcbDetailViewController;
