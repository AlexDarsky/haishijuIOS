...
@interface HaishijuXccbViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (strong,nonatomic) HaishijuXccbDetailViewController *gzcbDetailViewController;
