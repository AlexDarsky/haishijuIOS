...
@interface HaishijuZfzcxViewController ()

@end

@implementation HaishijuZfzcxViewController
...
- (void)viewDidLoad
{
    ...
    sexsArray=[[NSMutableArray alloc] initWithCapacity:0];
    zfz_dateArray=[[NSMutableArray alloc] initWithCapacity:0];
    zfz_numArray=[[NSMutableArray alloc] initWithCapacity:0];
    zfz_yxArray=[[NSMutableArray alloc] initWithCapacity:0];
    total=0;
    totalPage=0;
    currentPage=0;
    keyWordsArray=[[NSArray alloc] initWithObjects:@"姓名",@"性别",@"单位",@"执法证编号",@"发证日期",@"有效期" ,nil];
    keyWordsString=[[NSArray alloc] initWithObjects:@"username",@"sex",@"department",@"zfz_num",@"zfz_date",@"zfz_yx", nil];
    ...
    gzcbDetailViewController=[[HaishijuZfzcxDetailViewController alloc] init];
}
...
//    NSString *urlString =[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&Page=%d",1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row==0)
    {
        ...
        UILabel *chuanmingLabel=[[UILabel alloc] initWithFrame:CGRectMake(40, 10, 180, 40)];
        chuanmingLabel.text=@"单位";
        UILabel *chuanjigangLabel=[[UILabel alloc] initWithFrame:CGRectMake(220, 10, 100, 40)];
        chuanjigangLabel.text=@"姓名";;
...
-(IBAction)tapBotAction:(id)sender
{
    ...
    switch ([sender tag]) {
        case 1:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,currentPage];
            NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            ...
            if ([idsArray count]>0) {
                ...
                [sexsArray removeAllObjects];
                [zfz_numArray removeAllObjects];
                [zfz_dateArray removeAllObjects];
                [zfz_yxArray removeAllObjects];
            ...
            for (NSDictionary *dic in dataList)
            {
                ...
                [chuanmingsArray addObject:[dic objectForKey:@"department"]];
                [chuanjigangsArray addObject:[dic objectForKey:@"username"]];
                [sexsArray addObject:[dic objectForKey:@"sex"]];
                [zfz_numArray addObject:[dic objectForKey:@"zfz_num"]];
                [zfz_dateArray addObject:[dic objectForKey:@"zfz_date"]];
                [zfz_yxArray addObject:[dic objectForKey:@"zfz_yx"]];
            }
        ...
        case 2:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
                NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,currentPage+1];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        case 3:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
                NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,currentPage+2];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        {if (button4.selected==NO) {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,currentPage+3];
            NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        case 5:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
                NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,totalPage];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
...
{
    NSLog(@"buttonIndex is %d,currentPage is %d",buttonIndex,currentPage+buttonIndex);
    switch (buttonIndex) {
        case 1:
        {
            if (button1.selected==NO){
...
- (IBAction)searchAction:(id)sender
{
    ...
    currentPage=1;
        ...
        urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=jfryjf&searchField=%@&keyword=%@&Page=%d",self.searchFieldString,self.serachField.text,currentPage];
    NSLog(@"%@",urlString);
    NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
    NSArray *dataList=[[NSArray alloc] initWithArray:[initDic objectForKey:@"datalist"]];
    NSLog(@"%d",[dataList count]);
...
-(void)pushAction:(id)sender
{
    ...
    [gzcbDetailViewController setInfoByUsername:[idsArray objectAtIndex:[sender tag]] :[chuanjigangsArray objectAtIndex:[sender tag]] :[sexsArray objectAtIndex:[sender tag]] :[chuanmingsArray objectAtIndex:[sender tag]] :[zfz_numArray objectAtIndex:[sender tag]] :[zfz_dateArray objectAtIndex:[sender tag]] :[zfz_yxArray objectAtIndex:[sender tag]]];
