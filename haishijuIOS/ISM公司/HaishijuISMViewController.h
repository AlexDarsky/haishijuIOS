...
@interface HaishijuISMViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (strong,nonatomic) HaishijuISMDetailViewController *gzcbDetailViewController;
