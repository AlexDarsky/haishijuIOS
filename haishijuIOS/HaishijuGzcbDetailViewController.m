...
#import "HaishijuGzcbDetailViewController.h"
#import "HaishijuServerHelper.h"

@interface HaishijuGzcbDetailViewController ()

@end

@implementation HaishijuGzcbDetailViewController
...
-(void)loadInfoBySendRequest:(NSString*)chuanID
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataDetail.asp?type=gzcb&ID=%@",chuanID];
    ...
    self.dengJiNO=[infoDic objectForKey:@"DengJiNO"];
    ...
    self.genZhongYuanyin=[infoDic objectForKey:@"GenZhongYuanyin"];
     self.faShenDate=[infoDic objectForKey:@"FaShenDate"];
