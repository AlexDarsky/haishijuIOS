...
@interface HaishijuCbshViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (strong,nonatomic) HaishijuCbshDetailViewController *gzcbDetailViewController;
