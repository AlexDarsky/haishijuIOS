...
@interface HaishijuNhcyViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
{
...
@property (strong,nonatomic) HaishijuNhcyDetailViewController *gzcbDetailViewController;
