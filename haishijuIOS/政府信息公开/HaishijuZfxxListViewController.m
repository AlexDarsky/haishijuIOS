...
- (void)viewDidLoad
{
    ...
    keyWordsArray=[[NSArray alloc] initWithObjects:@"索引号",@"文号",@"文章标题",@"文章内容",@"文章作者",@"录入者",@"关键字",@"文章ID",nil];
    keyWordsString=[[NSArray alloc] initWithObjects:@"index_number",@"MY_wh",@"Title",@"Content",@"Author",@"Inputer",@"Keywords",@"ArticleID", nil];
...
-(IBAction)tapBotAction:(id)sender
{
    ...
    switch ([sender tag]) {
        case 1:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,currentPage];
            NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
        ...
        case 2:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,currentPage+1];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        case 3:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,currentPage+2];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        {if (button4.selected==NO) {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,currentPage+3];
            NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
        ...
        case 5:
        {
            ...
            HaishijuServerHelper *serverHelper=[HaishijuServerHelper shareHaishijuServerHelper];
            NSString *urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,totalPage];
                NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
            if ([idsArray count]>0) {
                [idsArray removeAllObjects];
                [chuanmingsArray removeAllObjects];
...
- (IBAction)searchAction:(id)sender
{
    ...
    urlString=[NSString stringWithFormat:@"http://www.gdmsa.gov.cn/android/getDataList.asp?type=xxgk&searchField=%@&keyword=%@&classid=%@&Page=%d",self.searchFieldString,self.serachField.text,self.classID,currentPage];
    NSLog(@"%@",urlString);
    NSDictionary *initDic=[[NSDictionary alloc] initWithDictionary:[serverHelper sendRequestByUrl:urlString]];
    NSArray *dataList=[[NSArray alloc] initWithArray:[initDic objectForKey:@"datalist"]];
    NSLog(@"%d",[dataList count]);
